...
from src.links.models import Base
...
config.set_section_option(section, "POSTGRES_INTERNAL_PORT", os.getenv("POSTGRES_INTERNAL_PORT"))
...
target_metadata = [Base.metadata, BaseAuth.metadata]
